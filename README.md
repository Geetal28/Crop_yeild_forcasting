# Forecasting Crop Yield Using a Multilayer Perceptron 
...
- Final merged dataset ≈ 62,738 rows × 19 columns across 2010–2022.
...
1) Rainfall, snowfall, terrestrial water storage
2) Soil moisture (0–10, 10–40, 40–100, 100–200 cm)
3) Soil temperature (same depths as above)
4) Plant canopy surface water
5) Land Cover (percentages):
6) 17 classes: forests (evergreen/deciduous), shrublands, savannas, croplands, urban, wetlands, snow/ice, water
   
- Categorical: Country, crop (OHE)
...
- Hidden layers: tried [32,64] and [64,128] → final choice [64,32]
- Learning rate: tried 1e-5, 1e-4, 5e-4 → final choice 0.0001
- Epochs: 10
